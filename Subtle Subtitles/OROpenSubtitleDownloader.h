...
@property (assign) float subtitleRating;    // Modifié
...
@property (copy) NSString *subtitlePage;
@property (copy) NSString *movieName;
@property (copy) NSString *hearingImpaired;
@property (assign) NSInteger downloadCount;
@property (copy) NSString *bad;
@property (copy) NSString *subtitleLength;
@property (assign) NSInteger subtitleSize;
@property (copy) NSString *hd;
@property (copy) NSString *subAddDate;
